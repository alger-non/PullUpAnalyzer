...
class ResultsDrawer:
    ...
    REPS_NUMBERS_SIZE = cv2.getTextSize(MAX_SCORE_VALUE, DEFAULT_FONT, 1, REPS_NUMBERS_FONT_THICKNESS)[0][0]
    FAILS_NUMBERS_SIZE = cv2.getTextSize(MAX_SCORE_VALUE, DEFAULT_FONT, 1, FAILS_NUMBERS_FONT_THICKNESS)[0][0]
