...
class PullUpCounter:
    ...
    def create_video_writer(self):
        ...
        output_filename = f'{self.output_dir}/{self.short_input_filename}_out.avi'
    ...
    def create_audio_writer(self):
        ...
        audio = AudioProcessor(self.input_file, output_filename, f'{self.output_dir}/Result.avi')
        self.audio_writer = audio
        audio.get_audio()

    def write_video_with_sound(self):
        self.video_writer.release()
        self.audio_writer.add_events()
...
pull_up_counter.write_video_with_sound()