...
class Drawer:
    ...
    def draw_skeleton(frame, points, pose_pairs, line_color=YELLOW_COLOR, circle_color=RED_COLOR, radius=8,
        ...
        for pair in pose_pairs:
            ...
            if points[part_a] and points[part_b]:
                ...
                cv2.circle(frame, points[part_a], radius, circle_color, thickness=-1, lineType=cv2.FILLED)
                cv2.circle(frame, points[part_b], radius, circle_color, thickness=-1, lineType=cv2.FILLED)
    ...
    def draw_numbered_joints(frame, points: dict, needed_points: dict, circle_color=YELLOW_COLOR, text_color=RED_COLOR,
        ...
        for joint, point in points.items():
            ...
            cv2.circle(frame, (point[0], point[1]), radius, circle_color, thickness=-1, lineType=cv2.FILLED)
